...
- اسکریپت اصلی
```
sudo apt-get install python3 -y && apt-get install wget -y && apt-get install python3-pip -y && pip3 install colorama && pip3 install netifaces && apt-get install curl -y && python3 <(curl -Ls https://raw.githubusercontent.com/FTune12/DirectChis/main/chiseld.py --ipv4)
```
...
```
python3 <(curl -Ls https://raw.githubusercontent.com/FTune12/DirectChis/main/chiseld.py --ipv4)
```
--------------------------------------
...
```
bash -c "$(curl -fsSL https://raw.githubusercontent.com/FTune12/DirectChis/main/managed.sh)"	
```
